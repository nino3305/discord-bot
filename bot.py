...
async def on_ready():
    ...
    activity=discord.Activity(type=discord.ActivityType.watching, name="三月七")
)
...
async def on_ready():
    ...
    await bot2.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="如我所書"))
    try:
